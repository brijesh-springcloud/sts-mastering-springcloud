...
public interface CurrencyExchangeServiceProxy {
	...
	//public CurrencyConversionBean retriveExchangeValue(@RequestHeader(value = "Authorization", required = true) String authorizationHeader, @PathVariable String from, @PathVariable String to );
